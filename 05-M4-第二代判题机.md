...
> **考试相关度 ★★(Ch8 String)· 反射/单文件属工程** · 真题考 String `==`/equals、StringBuffer、Random/Math(读程序/选择)。**[第一步·拟合试卷]** 练 String/类库写法;**[第二步·工程化]** `config.txt` + `Class.forName` 反射工厂、单文件读写(反射/文件考试少考)。
