...
% ---- 彩色标题页(标题可由 \def\TitleMain / \TitleSub 覆盖)----
\providecommand{\TitleMain}{用 Mini-OJ 项目学 Java}
\providecommand{\TitleSub}{判题机三代演进}
\renewcommand{\maketitle}{%
\begin{titlepage}
\thispagestyle{empty}
\vspace*{2.2cm}
{\setlength{\fboxsep}{0pt}\noindent\colorbox{primary}{\parbox{\textwidth}{\centering\color{white}%
  \vspace{22pt}{\Huge\bfseries \TitleMain}\\[10pt]{\Large \TitleSub}\vspace{22pt}}}}
\vfill
