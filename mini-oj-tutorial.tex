...
\title{用 Mini-OJ 项目学 Java —— 判题机三代演进}
\author{winbeau · Mini-OJ 教学项目}
\date{2026-06}
...
\hypertarget{1-ux5224ux9898ux673aux4e09ux4ee3ux4e3bux7ebfux5168ux9879ux76eeux7684ux9aa8ux67b6}{%
\subsection{1.
判题机三代主线(全项目的骨架)}\label{1-ux5224ux9898ux673aux4e09ux4ee3ux4e3bux7ebfux5168ux9879ux76eeux7684ux9aa8ux67b6}}
...
\hypertarget{2-ux5173ux952eux8bbeux8ba1ux51b3ux7b56}{%
\subsection{2.
关键设计决策}\label{2-ux5173ux952eux8bbeux8ba1ux51b3ux7b56}}
...
\hypertarget{3-ux6700ux7ec8ux5305ux7ed3ux6784ux9010ux7ae0ux957fux51faux6765}{%
\subsection{3.
最终包结构(逐章长出来)}\label{3-ux6700ux7ec8ux5305ux7ed3ux6784ux9010ux7ae0ux957fux51faux6765}}
...
\hypertarget{4-ux5168ux91cfux7c7bux63a5ux53e3ux6e05ux5355}{%
\subsection{4.
全量类/接口清单}\label{4-ux5168ux91cfux7c7bux63a5ux53e3ux6e05ux5355}}
...
\hypertarget{5-ux6838ux5fc3ux6570ux636eux6a21ux578bux5951ux7ea6ux7b7eux540dux9501ux5b9aux540eux7eedux7ae0ux8282ux7167ux6b64ux5b9eux73b0}{%
\subsection{5.
核心数据模型契约(签名锁定,后续章节照此实现)}\label{5-ux6838ux5fc3ux6570ux636eux6a21ux578bux5951ux7ea6ux7b7eux540dux9501ux5b9aux540eux7eedux7ae0ux8282ux7167ux6b64ux5b9eux73b0}}
...
\hypertarget{6-ux547dux540d--ux98ceux683cux7ea6ux5b9a}{%
\subsection{6. 命名 /
风格约定}\label{6-ux547dux540d--ux98ceux683cux7ea6ux5b9a}}
...
\hypertarget{7-ux6587ux6863ux6e05ux5355ux672cux7cfbux5217}{%
\subsection{7.
文档清单(本系列)}\label{7-ux6587ux6863ux6e05ux5355ux672cux7cfbux5217}}
...
\hypertarget{01--ux7b2c1ux7ae0-ux73afux5883ux4e0e-helloworldux91ccux7a0bux7891-m0}{%
\section{01 · 第1章 环境与 HelloWorld(里程碑
M0)}\label{01--ux7b2c1ux7ae0-ux73afux5883ux4e0e-helloworldux91ccux7a0bux7891-m0}}
...
\hypertarget{02--ux7b2c2-3ux7ae0-ux5355ux9898ux5224ux9898ux5668ux91ccux7a0bux7891-m1}{%
\section{02 · 第2-3章 单题判题器(里程碑
M1)}\label{02--ux7b2c2-3ux7ae0-ux5355ux9898ux5224ux9898ux5668ux91ccux7a0bux7891-m1}}
...
\hypertarget{03--ux7b2c4ux7ae0-ux5bf9ux8c61ux5efaux6a21ux91ccux7a0bux7891-m2}{%
\section{03 · 第4章 对象建模(里程碑
M2)}\label{03--ux7b2c4ux7ae0-ux5bf9ux8c61ux5efaux6a21ux91ccux7a0bux7891-m2}}

\begin{quote}
\textbf{考试相关度 ★★★(编程大题核心)} ·
真题考点参考:定义类(属性/构造/get-set/封装)。\textbf{{[}第一步·考试向{]}}
用考试级写法把 OJ 的 \texttt{TestCase/Problem/JudgeResult}
写成最简普通类(字段+构造+get/set),能 new
能打印;\textbf{{[}第二步·工程向{]}} 收成 \texttt{ProblemMeta} +
\texttt{static} 计数 + 包/jar。
\end{quote}
...
\hypertarget{statusenum--ojcorestatusjava}{%
\subsubsection{\texorpdfstring{Status(enum) ---
\texttt{oj/core/Status.java}}{Status(enum) --- oj/core/Status.java}}\label{statusenum--ojcorestatusjava}}
...
\hypertarget{testcase--ojcoretestcasejava}{%
\subsubsection{\texorpdfstring{TestCase ---
\texttt{oj/core/TestCase.java}}{TestCase --- oj/core/TestCase.java}}\label{testcase--ojcoretestcasejava}}
...
\hypertarget{problem--ojcoreproblemjavaux5bf9ux8c61ux6570ux7ec4--ux6784ux9020ux91cdux8f7d--ux53efux53d8ux53c2ux6570}{%
\subsubsection{\texorpdfstring{Problem ---
\texttt{oj/core/Problem.java}(对象数组 + 构造重载 +
可变参数)}{Problem --- oj/core/Problem.java(对象数组 + 构造重载 + 可变参数)}}\label{problem--ojcoreproblemjavaux5bf9ux8c61ux6570ux7ec4--ux6784ux9020ux91cdux8f7d--ux53efux53d8ux53c2ux6570}}
...
\hypertarget{judgeresult--ojcorejudgeresultjava}{%
\subsubsection{\texorpdfstring{JudgeResult ---
\texttt{oj/core/JudgeResult.java}}{JudgeResult --- oj/core/JudgeResult.java}}\label{judgeresult--ojcorejudgeresultjava}}
...
\hypertarget{submission--ojcoresubmissionjavaux7c7bux53d8ux91cf-static}{%
\subsubsection{\texorpdfstring{Submission ---
\texttt{oj/core/Submission.java}(类变量
static)}{Submission --- oj/core/Submission.java(类变量 static)}}\label{submission--ojcoresubmissionjavaux7c7bux53d8ux91cf-static}}
...
\hypertarget{solutionux672cux7ae0ux5177ux4f53ux7c7b--ojjudgeaplusbjava}{%
\subsubsection{\texorpdfstring{Solution(本章=具体类) ---
\texttt{oj/judge/AplusB.java}}{Solution(本章=具体类) --- oj/judge/AplusB.java}}\label{solutionux672cux7ae0ux5177ux4f53ux7c7b--ojjudgeaplusbjava}}
...
\hypertarget{simplejudge--ojjudgesimplejudgejavaux672cux7ae0ux6838ux5fc3}{%
\subsubsection{\texorpdfstring{SimpleJudge ---
\texttt{oj/judge/SimpleJudge.java}(本章核心)}{SimpleJudge --- oj/judge/SimpleJudge.java(本章核心)}}\label{simplejudge--ojjudgesimplejudgejavaux672cux7ae0ux6838ux5fc3}}
...
\hypertarget{mainux6f14ux793a--ojmainjava}{%
\subsubsection{\texorpdfstring{Main(演示) ---
\texttt{oj/Main.java}}{Main(演示) --- oj/Main.java}}\label{mainux6f14ux793a--ojmainjava}}
...
\hypertarget{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux628a-oj-ux7684ux6570ux636eux5199ux6210ux6700ux7b80ux666eux901aux7c7b}{%
\subsubsection{第一步 {[}考试向{]} --- 把 OJ
的数据写成最简普通类}\label{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux628a-oj-ux7684ux6570ux636eux5199ux6210ux6700ux7b80ux666eux901aux7c7b}}
...
\hypertarget{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--ux5347ux7ea7ux4e3aux5951ux7ea6ux7248}{%
\subsubsection{第二步 {[}工程向{]} ---
升级为契约版}\label{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--ux5347ux7ea7ux4e3aux5951ux7ea6ux7248}}
...
\hypertarget{04--ux7b2c5-7ux7ae0-ux5224ux9898ux5668ux63a5ux53e3ux7ee7ux627fux591aux6001ux5f02ux5e38ux91ccux7a0bux7891-m3}{%
\section{04 · 第5-7章 判题器:接口/继承/多态/异常(里程碑
M3)}\label{04--ux7b2c5-7ux7ae0-ux5224ux9898ux5668ux63a5ux53e3ux7ee7ux627fux591aux6001ux5f02ux5e38ux91ccux7a0bux7891-m3}}

\begin{quote}
\textbf{考试相关度 ★★★(编程大题核心)} ·
真题考点参考:抽象类/继承/重写/多态/异常。\textbf{{[}第一步·考试向{]}}
用考试级写法写一个简单判题(把一题判出 AC/WA)+ try-catch
兜异常;\textbf{{[}第二步·工程向{]}} 抽成 \texttt{Judge} 接口 /
...
\hypertarget{ux63a5ux53e3-ojjudgejudgejava}{%
\subsubsection{\texorpdfstring{接口
\texttt{oj/judge/Judge.java}}{接口 oj/judge/Judge.java}}\label{ux63a5ux53e3-ojjudgejudgejava}}
...
\hypertarget{ux62bdux8c61ux7c7bux6a21ux677fux65b9ux6cd5ojjudgeabstractjudgejavaux672cux7ae0ux6838ux5fc3}{%
\subsubsection{\texorpdfstring{抽象类(模板方法)\texttt{oj/judge/AbstractJudge.java}------\textbf{本章核心}}{抽象类(模板方法)oj/judge/AbstractJudge.java------本章核心}}\label{ux62bdux8c61ux7c7bux6a21ux677fux65b9ux6cd5ojjudgeabstractjudgejavaux672cux7ae0ux6838ux5fc3}}
...
\hypertarget{ux5b50ux7c7bux7cbeux786eux5224ux9898ux5668-ojjudgestandardjudgejavaux7ee7ux627f--ux91cdux5199--super}{%
\subsubsection{\texorpdfstring{子类:精确判题器
\texttt{oj/judge/StandardJudge.java}(继承 + 重写 +
super)}{子类:精确判题器 oj/judge/StandardJudge.java(继承 + 重写 + super)}}\label{ux5b50ux7c7bux7cbeux786eux5224ux9898ux5668-ojjudgestandardjudgejavaux7ee7ux627f--ux91cdux5199--super}}
...
\hypertarget{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux4e00ux4e2aux7b80ux5355ux5224ux9898ux5668ux5224ux51fa-acwaux5e76ux7528-try-catch-ux515cux5f02ux5e38}{%
\subsubsection{第一步 {[}考试向{]} --- 一个简单判题器,判出 AC/WA,并用
try-catch
兜异常}\label{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux4e00ux4e2aux7b80ux5355ux5224ux9898ux5668ux5224ux51fa-acwaux5e76ux7528-try-catch-ux515cux5f02ux5e38}}
...
\hypertarget{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--ux62bdux8c61ux5316ux63a5ux53e3--ux6a21ux677f--ux591aux6001--ux81eaux5b9aux4e49ux5f02ux5e38}{%
\subsubsection{第二步 {[}工程向{]} --- 抽象化:接口 + 模板 + 多态 +
自定义异常}\label{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--ux62bdux8c61ux5316ux63a5ux53e3--ux6a21ux677f--ux591aux6001--ux81eaux5b9aux4e49ux5f02ux5e38}}
...
\hypertarget{05--m4-ux7b2cux4e8cux4ee3ux5224ux9898ux673ach8-ux5b57ux7b26ux4e32ux53cdux5c04--ch10-ux5355ux6587ux4ef6}{%
\section{05 · M4 第二代判题机（Ch8 字符串/反射 + Ch10
单文件）}\label{05--m4-ux7b2cux4e8cux4ee3ux5224ux9898ux673ach8-ux5b57ux7b26ux4e32ux53cdux5c04--ch10-ux5355ux6587ux4ef6}}

\begin{quote}
\textbf{考试相关度 ★★(Ch8 String)· 反射/单文件属工程} ·
真题考点参考:String
\texttt{==}/equals、StringBuffer、Random/Math。\textbf{{[}第一步·考试向{]}}
用 \texttt{trim/equals/split}+\texttt{StringBuilder} 做 OJ
的输出比对与判题报告;\textbf{{[}第二步·工程向{]}} \texttt{config.txt} +
...
\hypertarget{ojcoreproblemmeta}{%
\subsubsection{\texorpdfstring{\texttt{oj.core.ProblemMeta}}{oj.core.ProblemMeta}}\label{ojcoreproblemmeta}}
...
\hypertarget{ojcoreproblemm4-ux7248ux672c}{%
\subsubsection{\texorpdfstring{\texttt{oj.core.Problem}（M4
版本）}{oj.core.Problem（M4 版本）}}\label{ojcoreproblemm4-ux7248ux672c}}
...
\hypertarget{ojioconfigfile}{%
\subsubsection{\texorpdfstring{\texttt{oj.io.ConfigFile}}{oj.io.ConfigFile}}\label{ojioconfigfile}}
...
\hypertarget{ojiosinglefileproblemloader}{%
\subsubsection{\texorpdfstring{\texttt{oj.io.SingleFileProblemLoader}}{oj.io.SingleFileProblemLoader}}\label{ojiosinglefileproblemloader}}
...
\hypertarget{ojjudgejudgefactory}{%
\subsubsection{\texorpdfstring{\texttt{oj.judge.JudgeFactory}}{oj.judge.JudgeFactory}}\label{ojjudgejudgefactory}}
...
\tightlist
\item
  \texttt{Class\textless{}?\textgreater{}}
  用通配符，因为编译期不知道具体类型。
\item
  \texttt{getDeclaredConstructor()} 比
  \texttt{newInstance()}（已废弃）更规范。
\item
  强制转型 \texttt{(Judge)} 若配置文件写错类名会在运行期抛
...
\hypertarget{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux7528-string-ux5199-oj-ux7684ux8f93ux51faux6bd4ux5bf9--ux62a5ux544a}{%
\subsubsection{第一步 {[}考试向{]} --- 用 String 写 OJ 的输出比对 +
报告}\label{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux7528-string-ux5199-oj-ux7684ux8f93ux51faux6bd4ux5bf9--ux62a5ux544a}}
...
\hypertarget{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--ux914dux7f6eux9a71ux52a8--ux53cdux5c04ux5de5ux5382}{%
\subsubsection{第二步 {[}工程向{]} --- 配置驱动 +
反射工厂}\label{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--ux914dux7f6eux9a71ux52a8--ux53cdux5c04ux5de5ux5382}}
...
\hypertarget{06--m5a-ux7b2cux4e09ux4ee3ux5224ux9898ux673a}{%
\section{06 · M5a
第三代判题机}\label{06--m5a-ux7b2cux4e09ux4ee3ux5224ux9898ux673a}}

\begin{quote}
\textbf{考试相关度 ★★(Ch15 集合)· C++ 判题机属工程} ·
真题考点参考:ArrayList/LinkedList/HashMap/Iterator。\textbf{{[}第一步·考试向{]}}
用 \texttt{ArrayList/HashMap} 把 OJ
的多组用例/题目装成内存题库;\textbf{{[}第二步·工程向{]}}
\texttt{ProblemLoader/Repository} + \texttt{ProcessBuilder} 调外部 C++
判题机 + 序列化。
\end{quote}
...
\texttt{judge.cpp}------与 Java 解耦,Java 只负责"调用 + 读结果"。它支持
\texttt{cpp/c/python/java},判 \texttt{AC/WA/PE/TLE/MLE/RE/CE},带
\texttt{setrlimit} + 进程组掐断 + 编译超时,健壮性不影响教学推进。
...
\textbf{破局方案}：Java
只做"调度员"，真正的编译、运行、资源限制全部委托给 C++ 编写的外部 judge
二进制。Java 用 \texttt{ProcessBuilder}
...
\item
  ...
  \texttt{new\ TestCase{[}n{]}}。
\item
  \texttt{List} 提供迭代器和 Stream，后续统计更方便。
\end{itemize}
...
\hypertarget{1-ojioproblemloader--ux626bux76eeux5f55ux8fd4ux56de-listtestcase}{%
\subsubsection{\texorpdfstring{1. \texttt{oj.io.ProblemLoader} ---
扫目录，返回
\texttt{List\textless{}TestCase\textgreater{}}}{1. oj.io.ProblemLoader --- 扫目录，返回 List\textless TestCase\textgreater{}}}\label{1-ojioproblemloader--ux626bux76eeux5f55ux8fd4ux56de-listtestcase}}
...
\hypertarget{2-ojioproblemrepository--hashmap-ux7f13ux5b58ux9898ux76ee}{%
\subsubsection{\texorpdfstring{2. \texttt{oj.io.ProblemRepository} ---
\texttt{HashMap}
缓存题目}{2. oj.io.ProblemRepository --- HashMap 缓存题目}}\label{2-ojioproblemrepository--hashmap-ux7f13ux5b58ux9898ux76ee}}
...
\hypertarget{3-ojiosubmissionstore--ux5bf9ux8c61ux5e8fux5217ux5316ux6301ux4e45ux5316}{%
\subsubsection{\texorpdfstring{3. \texttt{oj.io.SubmissionStore} ---
对象序列化持久化}{3. oj.io.SubmissionStore --- 对象序列化持久化}}\label{3-ojiosubmissionstore--ux5bf9ux8c61ux5e8fux5217ux5316ux6301ux4e45ux5316}}
...
\hypertarget{4-ojjudgemachinejudge--ux7b2cux4e09ux4ee3ux5224ux9898ux673aux6838ux5fc3}{%
\subsubsection{\texorpdfstring{4. \texttt{oj.judge.MachineJudge} ---
第三代判题机核心}{4. oj.judge.MachineJudge --- 第三代判题机核心}}\label{4-ojjudgemachinejudge--ux7b2cux4e09ux4ee3ux5224ux9898ux673aux6838ux5fc3}}
...
\hypertarget{5-stream-ux7edfux8ba1ux6f14ux793aux6574ux5408ux793aux4f8b}{%
\subsubsection{5. Stream
统计演示（整合示例）}\label{5-stream-ux7edfux8ba1ux6f14ux793aux6574ux5408ux793aux4f8b}}
...
\hypertarget{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux7528ux96c6ux5408ux628a-oj-ux9898ux5e93ux88c5ux8fdbux5185ux5b58}{%
\subsubsection{第一步 {[}考试向{]} --- 用集合把 OJ
题库装进内存}\label{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux7528ux96c6ux5408ux628a-oj-ux9898ux5e93ux88c5ux8fdbux5185ux5b58}}
...
\hypertarget{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--ux626bux76eeux5f55ux9898ux5e93--ux5916ux90e8-c-ux5224ux9898ux673a}{%
\subsubsection{第二步 {[}工程向{]} --- 扫目录题库 + 外部 C++
判题机}\label{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--ux626bux76eeux5f55ux9898ux5e93--ux5916ux90e8-c-ux5224ux9898ux673a}}
...
\hypertarget{07--m5b-ux6570ux636eux5e93ux8854ux63a5ch11-jdbc--mysql}{%
\section{07 · M5b 数据库衔接（Ch11 JDBC +
MySQL）}\label{07--m5b-ux6570ux636eux5e93ux8854ux63a5ch11-jdbc--mysql}}

\begin{quote}
\textbf{考试相关度 ★★} ·
真题考点参考:\texttt{Connection/Statement/ResultSet} 查询入
List、更新。\textbf{{[}第一步·考试向{]}} 用最简
JDBC(\texttt{Statement})把 OJ 的提交/题目存取
MySQL;\textbf{{[}第二步·工程向{]}}
\texttt{ProblemDao}/事务/\texttt{PreparedStatement}/\texttt{ProblemService}
的 FS/DB 分工。
...
\texttt{rs.next()} 把游标从"结果集首行之前"推进一行，返回 \texttt{false}
表示遍历完毕。列索引从 1 开始，或用列名 \texttt{rs.getString("title")}。
...
\hypertarget{ojdbdb--ux5355ux4f8bux8fdeux63a5ux7ba1ux7406}{%
\subsubsection{\texorpdfstring{\texttt{oj.db.Db} ---
单例连接管理}{oj.db.Db --- 单例连接管理}}\label{ojdbdb--ux5355ux4f8bux8fdeux63a5ux7ba1ux7406}}
...
\hypertarget{ojdbproblemdao--ux5143ux6570ux636e-crud}{%
\subsubsection{\texorpdfstring{\texttt{oj.db.ProblemDao} --- 元数据
CRUD}{oj.db.ProblemDao --- 元数据 CRUD}}\label{ojdbproblemdao--ux5143ux6570ux636e-crud}}
...
\hypertarget{ojdbsubmissiondao--ux63d0ux4ea4ux5386ux53f2ux6301ux4e45ux5316ux5e26ux4e8bux52a1}{%
\subsubsection{\texorpdfstring{\texttt{oj.db.SubmissionDao} ---
提交历史持久化（带事务）}{oj.db.SubmissionDao --- 提交历史持久化（带事务）}}\label{ojdbsubmissiondao--ux63d0ux4ea4ux5386ux53f2ux6301ux4e45ux5316ux5e26ux4e8bux52a1}}
...
\hypertarget{ojserviceproblemservice--fsdb-ux5408ux5e76ux5165ux53e3}{%
\subsubsection{\texorpdfstring{\texttt{oj.service.ProblemService} ---
FS/DB
合并入口}{oj.service.ProblemService --- FS/DB 合并入口}}\label{ojserviceproblemservice--fsdb-ux5408ux5e76ux5165ux53e3}}
...
\hypertarget{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux6700ux7b80-jdbcux5efaux8868ux63d2ux5165ux67e5ux8be2statement}{%
\subsubsection{第一步 {[}考试向{]} --- 最简
JDBC:建表/插入/查询(Statement)}\label{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux6700ux7b80-jdbcux5efaux8868ux63d2ux5165ux67e5ux8be2statement}}
...
\hypertarget{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--dao--ux4e8bux52a1--ux9884ux5904ux7406--fsdb-ux5206ux5de5}{%
\subsubsection{第二步 {[}工程向{]} --- DAO + 事务 + 预处理 + FS/DB
分工}\label{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--dao--ux4e8bux52a1--ux9884ux5904ux7406--fsdb-ux5206ux5de5}}
...
\hypertarget{08--m5c-swing-ux684cux9762ux5ba2ux6237ux7aefch9ux5927ux524dux7aef}{%
\section{08 · M5c Swing
桌面客户端（Ch9，大前端）}\label{08--m5c-swing-ux684cux9762ux5ba2ux6237ux7aefch9ux5927ux524dux7aef}}

\begin{quote}
\textbf{考试相关度 ★★★(编程+填空双大题)} ·
真题考点参考:JFrame/布局/JButton/JTextField/JLabel/ActionListener。\textbf{{[}第一步·考试向{]}}
用考试级 Swing 写 OJ
提交窗口最简版(选题+输入+提交按钮+标签显示判题结果);\textbf{{[}第二步·工程向{]}}
\texttt{OjFrame}/\texttt{OjController} MVC 解耦 + SwingWorker。
\end{quote}
...
\hypertarget{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux6700ux7b80-oj-ux63d0ux4ea4ux7a97ux53e3ux5355ux6587ux4ef6}{%
\subsubsection{第一步 {[}考试向{]} --- 最简 OJ
提交窗口(单文件)}\label{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux6700ux7b80-oj-ux63d0ux4ea4ux7a97ux53e3ux5355ux6587ux4ef6}}
...
\hypertarget{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--mvc-ux89e3ux8026--ux540eux53f0ux5224ux9898}{%
\subsubsection{第二步 {[}工程向{]} --- MVC 解耦 +
后台判题}\label{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--mvc-ux89e3ux8026--ux540eux53f0ux5224ux9898}}
...
\hypertarget{09--m6a-ux591aux7ebfux7a0bux5e76ux53d1ux5224ux9898ch12ux6536ux5b98ux603bux51b3ux8d5b}{%
\section{09 · M6a
多线程并发判题（Ch12，收官总决赛）}\label{09--m6a-ux591aux7ebfux7a0bux5e76ux53d1ux5224ux9898ch12ux6536ux5b98ux603bux51b3ux8d5b}}

\begin{quote}
\textbf{考试相关度 ★★} ·
真题考点参考:\texttt{extends\ Thread}/run/start、join、synchronized。\textbf{{[}第一步·考试向{]}}
给 OJ 判题加最简并发(\texttt{Thread/Runnable} +
\texttt{synchronized/join});\textbf{{[}第二步·工程向{]}} 泛型阻塞队列 +
工作线程池 + 调 C++ 判题机。
\end{quote}
...
\texttt{if}------这是防范**虚假唤醒（spurious wakeup）**的标准写法。
...
Swing
的所有界面操作必须在\textbf{事件派发线程（EDT）\textbf{上执行；而判题调用（ProcessBuilder、文件
IO）必须在}后台线程}上执行，否则界面冻结。\texttt{SwingWorker\textless{}T,\ V\textgreater{}}
提供了标准的两阶段模型：
...
\hypertarget{ojcorejudgetask}{%
\subsubsection{oj.core.JudgeTask}\label{ojcorejudgetask}}
...
\hypertarget{ojjudgequeuejudgequeue}{%
\subsubsection{oj.judge.queue.JudgeQueue}\label{ojjudgequeuejudgequeue}}
...
\hypertarget{ojjudgequeuejudgeworker}{%
\subsubsection{oj.judge.queue.JudgeWorker}\label{ojjudgequeuejudgeworker}}
...
\hypertarget{ojguiojcontroller--swingworker-ux63d0ux4ea4}{%
\subsubsection{oj.gui.OjController --- SwingWorker
提交}\label{ojguiojcontroller--swingworker-ux63d0ux4ea4}}
...
\hypertarget{ojguiojframe--ux754cux9762ux9aa8ux67b6}{%
\subsubsection{oj.gui.OjFrame ---
界面骨架}\label{ojguiojframe--ux754cux9762ux9aa8ux67b6}}
...
\hypertarget{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux6700ux7b80ux5e76ux53d1ux5224ux9898thread--synchronized--join}{%
\subsubsection{第一步 {[}考试向{]} --- 最简并发判题:Thread +
synchronized +
join}\label{ux7b2cux4e00ux6b65-ux8003ux8bd5ux5411--ux6700ux7b80ux5e76ux53d1ux5224ux9898thread--synchronized--join}}
...
\hypertarget{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--ux6cdbux578bux963bux585eux961fux5217--ux5de5ux4f5cux7ebfux7a0bux6c60--ux8c03-c-ux5224ux9898ux673a}{%
\subsubsection{第二步 {[}工程向{]} --- 泛型阻塞队列 + 工作线程池 + 调
C++
判题机}\label{ux7b2cux4e8cux6b65-ux5de5ux7a0bux5411--ux6cdbux578bux963bux585eux961fux5217--ux5de5ux4f5cux7ebfux7a0bux6c60--ux8c03-c-ux5224ux9898ux673a}}
